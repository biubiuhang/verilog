...
HD_PWD='D:/Zynq/youlaoshi_first/net9_clkdiv/programmer_ledflash/led_flash/led_flash.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flash_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flash_led.tcl
