...
HD_PWD='D:/Zynq/youlaoshi_first/net9_clkdiv/programmer_ledflash/led_flash/led_flash.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flash_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flash_led.tcl -notrace
